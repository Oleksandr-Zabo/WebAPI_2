...
namespace WebAPI_2.Abstract
{
    ...
    {
        (bool Success, string ErrorMessage, Guid? Id) Save(CreateUpdateBookRequest request);
        (bool Success, string ErrorMessage) Update(Guid id, CreateUpdateBookRequest request);
